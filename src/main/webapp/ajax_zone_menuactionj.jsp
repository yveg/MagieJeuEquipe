...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
 <table>
<tr><td><img class="inviz"  id="invisibility" src="Images/sort/invisibilite.png" alt="le joueur prend 1 carte(au hasard) chez tous ses adversaires
...
<td><img class="inviz"  id="filtre_amour" src="Images/sort/elixir.png" alt="le joueur de votre choix vous donne la moitie de ses cartes(au hasard). S il ne possede qu une carte il a perdu" >&nbsp;
<span class="invi">
...
<td><img class="inviz"   id="hypnose" src="Images/sort/hypnose.png"  alt="" />&nbsp;
<span class="invi">
...
<td><img class="inviz"   id="sommeil" src="Images/sort/sommeil.png"  alt="" />&nbsp;
<span class="invi">
...
<td><img class="inviz"   id="divination" src="Images/sort/divination.png"  alt="" />&nbsp;
<span class="invi">
 ...
 <input type="submit" value="confirmer les selections" onclick="">
