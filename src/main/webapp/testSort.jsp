                ...
                <div class="menuactionj">
                    <table>
                        <form class="sortilege">
                            <tr><td><input class="inviz" type="image" onclick="/" value="invisibility" src="Images/sort/invisibilite.png" alt="le joueur prend 1 carte(au hasard) chez tous ses adversaires
